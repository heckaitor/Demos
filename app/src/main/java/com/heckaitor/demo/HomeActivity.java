...
public class HomeActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private int item2Index(int itemId) {
        switch (itemId) {
            ...
            case R.id.nav_content: return 1;
            case R.id.nav_tools: return 2;
            default: return -1;
        }
    }
    ...
    private int index2Item(int index) {
        switch (index) {
            ...
            case 1: return R.id.nav_content;
            case 2: return R.id.nav_tools;
            default: return -1;
        }
    }
}
