...
public abstract class LogNode implements Loggable {
    ...
    public abstract LogNodeFactory.LoggerType getType();
    ...
    private String generateTag(Object caller) {
        if (caller instanceof String) {
            ...
            final String tagString = caller != null ? caller.getClass().getSimpleName() : "";
            return !TextUtils.isEmpty(tagString) ? tagString : "demo";
        }
    }
